...
void display(){
    ...
    std::vector<Point> rect = {{-150,-50},{-50,-50},{-50,50},{-150,50}};
    ...
    std::vector<Point> sheared = applyTransform(rect,Sh);
    glColor3f(1,0,0); drawRectangle(sheared);
...
int main(int argc,char** argv){
    ...
    glutCreateWindow("2D Shearing (Matrix)");
