...
void display(){
    ...
    glColor3f(1,1,1); drawRectangle(rect); 
    ...
    std::vector<Point> translated = applyTransform(rect,T);
    glColor3f(1,0,0); drawRectangle(translated);
...
int main(int argc,char** argv){
    ...
    glutCreateWindow("2D Translation (Matrix)");
